...
alias nga='sudo nginx -t && sudo nginx -s reload; sudo systemctl start nginx.service && sudo service nginx start; sudo systemctl start mysql && sudo systemctl start php8.2-fpm'
alias ngo='sudo nginx -t && sudo nginx -s reload; sudo systemctl stop nginx.service && sudo service nginx stop; sudo systemctl stop mysql && sudo systemctl stop php8.2-fpm'
...
alias zba='sudo systemctl start zabbix-server zabbix-agent'
alias zbo='sudo systemctl stop zabbix-server zabbix-agent'
alias zbr='sudo systemctl restart zabbix-server zabbix-agent'
alias ska='screenkey &'
